...
public class RedisUtils {
    ...
    */
    ...
    public List<Point> geoGet(String name) {
        return redisTemplate.opsForGeo().position("geo", name);
    }
    ...
    public GeoResults<RedisGeoCommands.GeoLocation<Object>> geoMember(String member) {
        ...
        GeoResults<RedisGeoCommands.GeoLocation<Object>> geoResults = this.redisTemplate.opsForGeo().radius("geo", member, distance, args);
        return geoResults;
    }
    ...
    public GeoResults<RedisGeoCommands.GeoLocation<Object>> geoRadius(double longitude, double latitude) {
        ...
        //返回结果按距离升序，包含距离和经纬度, 返回50条
        RedisGeoCommands.GeoRadiusCommandArgs args = RedisGeoCommands.GeoRadiusCommandArgs.newGeoRadiusArgs().includeDistance().includeCoordinates().sortAscending().limit(50);
        GeoResults<RedisGeoCommands.GeoLocation<Object>> geoResults = this.redisTemplate.opsForGeo().radius("geo", circle, args);
        return geoResults;
    }
